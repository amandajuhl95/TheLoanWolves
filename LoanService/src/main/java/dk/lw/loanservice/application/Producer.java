...
public class Producer {
    ...
    private static final String TOPIC = "loan-accept";
    private static final String AMORTIZATION_TOPIC = "amortization-request";

    @Autowired
    private KafkaTemplate<String, String> requestTemplate;

    public void sendLoan(UUID userId, UUID loanQuoteId)
    {
        LoanAdmissionDTO loanAdmissionDTO = new LoanAdmissionDTO(userId, loanQuoteId);
